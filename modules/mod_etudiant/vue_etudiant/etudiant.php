    ...
    <div id="etud<?=$donnees['numeroINE']?>" class="col-md-12 shadow-sm lighten-4" data-toggle="modal" id="divsEtud" >
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 card-body">
                    ...
                    <p style=""> Numero INE : <?=$donnees['numeroINE']?></p>
                </div>
                ...
                <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 card-body">
                    <a id="boutonModif" class=" btn optionMenu " href="index.php?module=etudiant&action=formModifEtud&idEtud=<?=$donnees['numeroINE']?>"  ><img src="bootstrap-icons/icons/pencil.svg" alt="+" width="32" height="32" title="Plus"> </a>
                </div>
                <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 card-body">

                <?php if($idGroupe == 0){
                    echo '<button class="suppEtud btn optionMenu " value="'.$donnees['numeroINE'].'"><img  src="bootstrap-icons/icons/trash-fill.svg" alt="+" width="32" height="32" title="trash-fill"> </a>';
                }
                else{
                    echo '<a class=" btn optionMenu " href="index.php?module=etudiant&action=suppEtudiant&idEtud='.$donnees['numeroINE'].'&idGroupe='.$idGroupe.'" ><img  src="bootstrap-icons/icons/trash-fill.svg" alt="+" width="32" height="32" title="Plus"> </a>supprimer du groupe';
                }
                ?>
                </div>
               ...
               $basicExampleModal = 'basicExampleModal' . $i // obligatoire pour éviter d'afficher le même étudiant à chaque fois, sinon il fait tjrs appel au même modal (car le même id qui ne changeait jamais)
                ?>
               <button type="button" id="boutonDet" class="details btn" value="<?=$donnees['numeroINE']?>" data-toggle="modal" title="cliquez pour avoir plus de détails" <?php echo 'data-target=#' . $basicExampleModal?>>
                  Plus de détails
                </button>
                            ...
                            <!-- Afficher tous les détails de l'étudiant -->
                                <div><img class="photoEtudBis" name="img" src='<?=$donnees['photoEtud']?>' ></div>
                                    <div id="divModal1">
                                        ...
                                        <p class="divModal1P">numero INE : <span class="text-uppercase"><?=$donnees['numeroINE']?></p>
                                    </div>
                                    <div id="divModal2">
                                    ...
                                    <!-- <p>Groupes</p> -->
                                    <div id="groupe<?=$donnees['numeroINE']?>">
                                    <!-- liste des groupes de l'etudiant-->
                                     </div>
                                    <!-- <p>Etablissements</p> -->
                                    <div id="etablissemnt<?=$donnees['numeroINE']?>">
