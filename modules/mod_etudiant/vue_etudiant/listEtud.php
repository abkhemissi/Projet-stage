...
if (!empty($idGroupe) && $idGroupe != 0)
   ...
   require('modules/mod_composant/vue_composant/barreRechercheEtud.php');
 ?>
...
if(!empty($listEtudiant)){
    ...
    foreach ($tab as $donnees) {
        ...
        if($donnees['numeroINE'] == '0')$donnees['numeroINE'] = "Non renseigné";
