...
<div  class="container-fluid" id="formCreate" style=""> 
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12  ">
        ...
        <span>Numéro INE : </span><input type="number" id="numeroINE" placeholder="numéro INE" value="<?=$numeroINE?>" name="numeroINE" style="width:16%;"
                        min="0" max="100000">                
...
if(!empty($etablissements)){
    ...
    foreach ($tab as $donnees) {
        require 'modules/mod_etablissement/vue_etablissement/formEtab.php';
        $nbEtab ++;
    }
}
