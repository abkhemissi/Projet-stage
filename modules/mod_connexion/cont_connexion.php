...
class ContConnexion extends ContGenerique {
    ...
    public function deconnexion() {
        ...
        session_unset();
        session_destroy();
       echo '<script>window.location.replace("index.php?module=connexion")</script>';
    }
    /* -------------------------- Connexion et Déconnexion -------------------------- */
    ...
    public function add_responsable() {
        ...
        if ((isset($_POST['identifiant']) && !empty($_POST['identifiant'])) && (isset($_POST['mp']) && !empty($_POST['mp'])) && (isset($_POST['mp_confirm']) && !empty($_POST['mp_confirm']))) {
            ...
            if ($_POST['mp'] != $_POST['mp_confirm']) {
                throw new formInsException('Les mots de passe saisis sont différents !');
            }
            else {
                ...
                if (empty($data)) {
                    ...
                    self::form_addResp();
                    $message = 'Le compte '. $identifiant . ' a bien été créé !';
